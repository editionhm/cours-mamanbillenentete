...
export const metadata: Metadata = {
  ...
  description: "Boostez la réussite de votre enfant avec Maman Bille-en-Tête. Cours de français, méthode et préparation aux concours (Brevet, Bac, CRPE, CAPES). Excellence scolaire.",
  keywords: ["Cours particuliers", "Soutien scolaire", "Français", "Préparation Concours", "CRPE", "CAPES", "Brevet", "Bac de Français", "Coaching scolaire", "Maman Bille-en-Tête", "Méthode"],
  authors: [{ name: "Maman Bille-en-Tête" }],
  openGraph: {
    title: "Maman Bille-en-Tête | L'Excellence Scolaire",
